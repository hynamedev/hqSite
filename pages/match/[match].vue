...
import {kitStore, matchStore, playerStatsStore, usernameStore, uuidStore} from "~/store/store.js";
...
function getDuration(date1, date2) {
  ...
  // Format the duration
  var duration = hours > 0 ? `${hours}:${minutes}:${seconds}` : `${minutes}:${seconds}`;

  return duration;
}

const player1 = matchStore().data.allPlayers[0];
const player2 = matchStore().data.allPlayers[1];

const kit = kitStore().data.displayName;
      ...
      <div class="content-body">
        <section id="content">
          ...
          <div class="row">
            <div class="col-2">
              <div class="text-center">
                <a :href="'/u/' + matchStore().data.postMatchPlayers[player1].lastUsername " class="avatar" v-if="matchStore().data.winningPlayers[0] === player1">
                  <img :src="'https://visage.surgeplay.com/full/400/' + player1 + '.png'" height="240" width="106" style="object-fit: contain; filter: drop-shadow(0 0 7px #008000);" class="avatar-half">
                </a>
                <a :href="'/u/' + matchStore().data.postMatchPlayers[player1].lastUsername" class="avatar" v-else>
                  <img :src="'https://visage.surgeplay.com/full/400/' + player1 + '.png'" height="240" width="106" style="object-fit: contain; filter: drop-shadow(0 0 7px #8B0000);" class="avatar-half">
                </a>
              </div>
            </div>
            <div class="col-4">
              <div class="row">
                <div class="col-12">
                  <div class="block w-100" style="height: 200px;padding: 20px;">
                        ...
                        <td v-for="i in [27, 28, 29, 30, 31, 32, 33, 34, 35]">
                          <span v-if="matchStore().data.postMatchPlayers[player1].inventory[i] != null">
                            ...
                            <div v-if="matchStore().data.postMatchPlayers[player1].inventory[i].count > 1" style="position: relative; width: 0; height: 0">
                              <div style="color: white; position: absolute; left: 14px; top: -20px">
                                {{ matchStore().data.postMatchPlayers[player1].inventory[i].count }}
                              </div>
                            </div>
                          </span>
                          <span v-else class="item item_ item__"></span>
                        </td>
                      </tr>
                      <tr>
                        <td v-for="i in [18, 19, 20, 21, 22, 23, 24, 25, 26]">
                          <span v-if="matchStore().data.postMatchPlayers[player1].inventory[i] != null">
                            <span
                                :class="'item item_' + matchStore().data.postMatchPlayers[player1].inventory[i].id +
                                ' item_' + matchStore().data.postMatchPlayers[player1].inventory[i].id +
              ...
              <div class="row">
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Health</h2>
                    {{ matchStore().data.postMatchPlayers[player1].health }} <i class="fa fa-heart" style="color: red" aria-hidden="true"></i>
                  </div>
                </div>
                <div class="col-4">
                  <div class="stats-block">
              ...
              <div class="row">
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Total Potions</h2>
                    {{ matchStore().data.postMatchPlayers[player1].thrownPots }}
                  </div>
                </div>
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Potion Accuracy</h2>

                    <div v-if="(matchStore().data.postMatchPlayers[player1].thrownPots / matchStore().data.postMatchPlayers[player1].missedPots) === Infinity">
                      100%
                    </div>
                    <div v-else-if="!isNaN((matchStore().data.postMatchPlayers[player1].thrownPots / matchStore().data.postMatchPlayers[player1].missedPots))">
                      {{ matchStore().data.postMatchPlayers[player1].thrownPots / matchStore().data.postMatchPlayers[player1].missedPots }}%
                    </div>
                    <div v-else>
                      N/A
                    </div>
                ...
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Debuff Accuracy</h2>
                    <div v-if="(matchStore().data.postMatchPlayers[player1].thrownDebuffs / matchStore().data.postMatchPlayers[player1].missedDebuffs) === Infinity">
                      100%
                    </div>
                    <div v-else-if="!isNaN((matchStore().data.postMatchPlayers[player1].thrownDebuffs / matchStore().data.postMatchPlayers[player1].missedDebuffs))">
                      {{ matchStore().data.postMatchPlayers[player1].thrownDebuffs / matchStore().data.postMatchPlayers[player1].missedDebuffs }}%
                    </div>
                    <div v-else>
                      N/A
                    </div>
            ...
            <div class="col-4">
                ...
                <div class="col-12">
                  <div class="block w-100" style="height: 200px; padding: 20px;">
                    <table style="background-repeat: no-repeat; background-size: cover; background-image: url(https://i.imgur.com/IoObQfJ.png)">
                      ...
                      <tr>
                        <td v-for="i in [27, 28, 29, 30, 31, 32, 33, 34, 35]">
                          <span v-if="matchStore().data.postMatchPlayers[player2].inventory[i] != null">
                            <span
                                :class="'item item_' + matchStore().data.postMatchPlayers[player2].inventory[i].id +
                                ' item_' + matchStore().data.postMatchPlayers[player2].inventory[i].id +
                                '_' + matchStore().data.postMatchPlayers[player2].inventory[i].data"></span>
                            <div v-if="matchStore().data.postMatchPlayers[player2].inventory[i].count > 1" style="position: relative; width: 0; height: 0">
                              <div style="color: white; position: absolute; left: 14px; top: -20px">
                                {{ matchStore().data.postMatchPlayers[player2].inventory[i].count }}
                              </div>
                            </div>
                          </span>
                          <span v-else class="item item_ item__"></span>
              ...
              <div class="row">
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Health</h2>
                    {{ matchStore().data.postMatchPlayers[player2].health }} <i class="fa fa-heart" style="color: red" aria-hidden="true"></i>
                  </div>
                </div>
                <div class="col-4">
                  <div class="stats-block">
              ...
              <div class="row">
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Total Potions</h2>
                    {{ matchStore().data.postMatchPlayers[player2].thrownPots }}
                  </div>
                </div>
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Potion Accuracy</h2>
                    <div v-if="(matchStore().data.postMatchPlayers[player2].thrownPots / matchStore().data.postMatchPlayers[player2].missedPots) === Infinity">
                      100%
                    </div>
                    <div v-else-if="!isNaN((matchStore().data.postMatchPlayers[player2].thrownPots / matchStore().data.postMatchPlayers[player2].missedPots))">
                      {{ matchStore().data.postMatchPlayers[player2].thrownPots / matchStore().data.postMatchPlayers[player2].missedPots }}%
                    </div>
                    <div v-else>
                      N/A
                    </div>
                ...
                <div class="col-4">
                  <div class="stats-block">
                    <h2>Debuff Accuracy</h2>
                    <div v-if="(matchStore().data.postMatchPlayers[player2].thrownDebuffs / matchStore().data.postMatchPlayers[player2].missedDebuffs) === Infinity">
                      100%
                    </div>
                    <div v-else-if="!isNaN((matchStore().data.postMatchPlayers[player2].thrownDebuffs / matchStore().data.postMatchPlayers[player2].missedDebuffs))">
                      {{ matchStore().data.postMatchPlayers[player2].thrownDebuffs / matchStore().data.postMatchPlayers[player2].missedDebuffs }}%
                    </div>
                    <div v-else>
                      N/A
                    </div>
            ...
            <div class="col-2">
              <div class="text-center">
                <a :href="'/u/' + matchStore().data.postMatchPlayers[player2].lastUsername" class="avatar" v-if="matchStore().data.winningPlayers[0] === player2">
                 <img :src="'https://visage.surgeplay.com/full/400/' + player2 + '.png?y=-40'" height="240" width="106" style="object-fit: contain; filter: drop-shadow(0 0 7px #008000);" class="avatar-half">
                </a>
                <a :href="'/u/' + matchStore().data.postMatchPlayers[player2].lastUsername" class="avatar" v-else>
                  <img :src="'https://visage.surgeplay.com/full/400/' + player2 + '.png?y=-40'" height="240" width="106" style="object-fit: contain; filter: drop-shadow(0 0 7px #8B0000);" class="avatar-half">
                </a>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-2 offset-4">
              <div class="block text-center">
                <h2>Map</h2>
                {{ matchStore().data.arena }}
              </div>
            </div>
            <div class="col-2">
              <div class="block text-center">
                <h2>Duration</h2>
                {{ getDuration(matchStore().data.startedAt, matchStore().data.endedAt) }}
...
.item {
  width: 32px;
  height: 32px;
  background-image: url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items.png);
...
/* potions */
.item_373_0 {background-position:0px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16 {background-position:-32px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_32 {background-position:-64px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_64 {background-position:-96px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8193 {background-position:-128px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8194 {background-position:-160px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8195 {background-position:-192px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8196 {background-position:-224px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8197 {background-position:-256px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8198 {background-position:-288px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8200 {background-position:-320px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8201 {background-position:-352px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8202 {background-position:-384px 0px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8204 {background-position:0px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8206 {background-position:-32px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8225 {background-position:-64px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8226 {background-position:-96px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8228 {background-position:-128px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8229 {background-position:-160px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8233 {background-position:-192px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8236 {background-position:-224px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8257 {background-position:-256px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8258 {background-position:-288px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8259 {background-position:-320px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8260 {background-position:-352px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8262 {background-position:-384px -32px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8264 {background-position:0px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8265 {background-position:-32px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8266 {background-position:-64px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_8270 {background-position:-96px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16384 {background-position:-128px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16385 {background-position:-160px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16386 {background-position:-192px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16387 {background-position:-224px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16388 {background-position:-256px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16389 {background-position:-288px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16390 {background-position:-320px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16392 {background-position:-352px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16393 {background-position:-384px -64px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16394 {background-position:0px -96px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16396 {background-position:-32px -96px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16398 {background-position:-64px -96px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16417 {background-position:-96px -96px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16418 {background-position:-128px -96px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
...
.item_373_16458 {background-position:-96px -128px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
.item_373_16462 {background-position:-128px -128px;background-image:url(https://raw.githubusercontent.com/web93onv/Minecraft-blocks-and-items-icons/master/blocks_items_potions.png);}
</style>
