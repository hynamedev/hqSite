...
}
{
    ...
    $(document).on('submit', '.profile-comment-form', function(e) {
        ...
        $.post(form.attr('action'), form.serialize()).fail(function(xhr, status, msg) {
...
/*
playback timings (ms):
  captures_list: 171.415
  exclusion.robots: 0.066
  exclusion.robots.policy: 0.058
  cdx.remote: 0.054
  esindex: 0.008
  LoadShardBlock: 141.645 (3)
  PetaboxLoader3.datanode: 61.224 (5)
  PetaboxLoader3.resolve: 192.542 (4)
  load_resource: 152.017 (2)
*/
